...
type Repository interface {
	...
	DeletePost(ctx context.Context, id string, user_id string) error
...
func DeletePost(ctx context.Context, id string, user_id string) error {
	return implementation.DeletePost(ctx, id, user_id)
}
