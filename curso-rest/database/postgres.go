...
import (
	...
	_ "github.com/lib/pq"
	"jjgdevelopment.com/go/rest-ws/models"
)
...
func (repo *PostgresRepository) InsertUser(ctx context.Context, user *models.User) error {
	...
	if err != nil {
		log.Printf("[ERROR] Error creating new user: ", err)
	}
...
func (repo *PostgresRepository) InsertPost(ctx context.Context, post *models.Post) error {
	...
	if err != nil {
		log.Printf("[ERROR] Error creating new post: ", err)
	}
...
func (repo *PostgresRepository) GetUserById(ctx context.Context, id string) (*models.User, error) {
	...
	if err != nil {
		log.Printf("[ERROR] Error getting user", err)
		return nil, err
	}
	...
	defer func() {
		err = rows.Close()
		if err != nil {
			log.Printf("[ERROR] Error closing connection", err)
		}
	}()
...
func (repo *PostgresRepository) GetPostById(ctx context.Context, id string) (*models.Post, error) {
	...
	if err != nil {
		log.Printf("[ERROR] Error getting post", err)
		return nil, err
	}
...
func (repo *PostgresRepository) DeletePost(ctx context.Context, id string, user_id string) error {
	_, err := repo.db.ExecContext(ctx, "DELETE FROM posts WHERE id = $1 and user_id = $2", id, user_id)
	return err
}
...
func (repo *PostgresRepository) ListPost(ctx context.Context, page uint64) ([]*models.Post, error) {
	...
	if err != nil {
		log.Printf("[ERROR] Error taking the select connection ", err)
		return nil, err
	}

	log.Printf("[ERROR] ENo entra en error de select")
	...
	for rows.Next() {
		var post = models.Post{}
		log.Printf("[ERROR] this is the post ", post)
